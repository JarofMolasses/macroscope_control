...
namespace Plot3D
{
    ...
    public class Editor3D : UserControl
    {
        ...
        public class cAxis
        {
            ...
            /// <summary>
            /// Here you can add a legend which is displayed .
        ...
        // IMPORTANT: Read the detailed comment of function SelectionCallback() at the end of this class.
        public delegate eInvalidate delSelectHandler(eAltEvent e_Event, Keys e_Modifiers, int s32_DeltaX, int s32_DeltaY, cObject3D i_Object);
